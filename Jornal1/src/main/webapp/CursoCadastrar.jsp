...
<% session = null; %>
    <div class="box">
       <form name="frmCurso" action="ControleCursoServletAction" method="post">
            <fieldset>
                <legend><b>Tela Curso - Cadastrar</b></legend>
                <br>
                <div class="inputBox">
                    <input type="text" name="txtNomeCurso" id="txtNomeCurso" class="inputUser" required>
                    <label for="nome" class="labelInput">Curso</label>
                </div>
				
                <br><br>
				 
				 	<input type="hidden" name="txtIdCurso" maxlength="45" value="0">
                ...
                <h3 style="submit">Retornar Tela Principal: <a href="TelaCurso.jsp" />Clicar</a></h3>
