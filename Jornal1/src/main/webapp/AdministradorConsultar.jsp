...
<h1 style="text-align: center;">Administrador - Consultar</h1>
<table>
<form name="frmFuncionario" action="ControleFuncionarioServletAction" method="post">
	...
	<tr>
	<th class="op2" style="font-size:100%;">Administrador(a): </th>	
	...
	<%for(FuncionarioHibernate funcionario : funcionarios){%>
	   <option value="<%=funcionario.getIdAdm()%>"><%=funcionario.getCargo()%></option>
	<% }  %>
	</select> <br><br></td>
	</tr>	
	<input type="hidden" name="txtRg" size="10" maxlength="10" value=""></td>
