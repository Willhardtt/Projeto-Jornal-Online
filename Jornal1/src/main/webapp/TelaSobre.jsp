...
<main class="flex-shrink-0">
  <div class="container">
    <h1 class="mt-5">Sobre o Projeto</h1>
    <p class="lead">Nome: Willyan Nascimento Alves de Lima</p>
     <p class="lead">Nome: Thayná Cordeiro Marques Moreira</p>
      <p class="lead">Turma: 3211B</p>
...
<footer class="footer mt-auto py-3 bg-light">
  <div class="container">
    <span class="text-muted">Espero que tenham gostado.</span>
  </div>
</footer>
