...
<% session = null; %>
    <div class="box">
       <form name="frmCargo" action="ControleCargoServletAction" method="post">
            <fieldset>
                <legend><b>Tela Cargo - Cadastrar</b></legend>
                <br>
                <div class="inputBox">
                    <input type="text" name="txtCargo" id="txtCargo" class="inputUser" required>
                    <label for="nome" class="labelInput">Cargo</label>
                </div>
                ...
                <h3 style="submit">Retornar Tela Principal: <a href="TelaCargo.jsp" />Clicar</a></h3>
